...
export const GOLDEN_SET: GoldenCompany[] = [
  // Early-stage — sparsely covered on the open web
  { name: "Lovable", domain: "lovable.dev", maturity: "early-stage" },
  ...
  { name: "Mintlify", domain: "mintlify.com", maturity: "early-stage" },
  ...
  // Enterprise — over-covered, different failure modes for cheap models
  ...
  { name: "Netflix", domain: "netflix.com", maturity: "enterprise" },
  { name: "Shopify", domain: "shopify.com", maturity: "enterprise" },
  { name: "Uber", domain: "uber.com", maturity: "enterprise" },
  { name: "Airbnb", domain: "airbnb.com", maturity: "enterprise" },
